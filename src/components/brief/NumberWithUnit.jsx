    ...
    <div>
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 bg-bg-elev border border-border rounded-md px-3 py-2.5 text-sm text-fg placeholder:text-fg-faint focus:outline-none focus:border-accent transition-colors"
        />
        {freeUnit ? (
          <input
            type="text"
