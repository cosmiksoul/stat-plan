    ...
    <aside className="bg-bg-elev border border-border rounded-lg p-5 self-start">
      ...
      <ol className="m-0 p-0 list-none space-y-1">
        ...
        <li className="pt-3 mt-3 border-t border-border-soft">
          <div className="flex items-baseline gap-2 py-1.5 px-1.5 opacity-50">
            <span className="font-mono text-xs w-4 text-center text-fg-faint">
              +
            </span>
            <span className="text-sm text-fg-dim flex-1">
              Data peek (опционально)
            </span>
            <span className="mono-label text-fg-faint">SPRINT 3+</span>
          </div>
        </li>
      </ol>
    </aside>
