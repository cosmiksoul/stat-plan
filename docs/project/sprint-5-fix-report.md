...
> Источник прицеливания: `docs/project/sprint-5-fix-prompt.md` (C-1..C-4). План в чате (без отдельного `.claude/plans` файла — диффы маленькие, ExitPlanMode не понадобился).
