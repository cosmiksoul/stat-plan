...
**Источник:** `docs/project/sprint-9-prompt.md` Phase 2 (K-1..K-6) + `docs/project/sprint-9-report.md`.
...
- `docs/project/sprint-9-prompt.md` — spec Phase 2 K-1..K-6
- `docs/project/sprint-9-report.md` — Code отчёт (2 коммита: 6462c18 main + 3072451 report correction)
- `docs/project/test-cases-sprint-9-retest.md` — runnable browser smoke (TBD)
