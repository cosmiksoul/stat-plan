...
**Источник:** `docs/project/sprint-8-prompt.md` P-1..P-14 + `docs/project/sprint-8-report.md`.
...
- `docs/project/sprint-8-prompt.md` — спека P-1..P-14
- `docs/project/sprint-8-report.md` — отчёт Code (переименован из sprint-polish-v2-report.md)
- `docs/project/test-cases-sprint-8-retest.md` — runnable smoke (TBD)
