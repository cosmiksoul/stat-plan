...
**Контекст iter 1:** см. `docs/project/sprint-6-fix-prompt.md` для истории C-1, C-2, BUG-Q1/Q3/Q4 + первоначальных Phase A/B/D/E. **Iter 2 фокусируется только на новых пунктах** — не переписывает уже сделанное.
...
3. Browser smoke по `docs/project/test-cases-sprint-6-fix-retest.md` — все 7 кейсов проходят (кейс 2 учитывает Phase F new behavior).
...
- `docs/project/sprint-6-fix-prompt.md` — iter 1 prompt (исторический контекст: C-1, C-2, BUG-Q1/Q3/Q4 + Phase A/B/D/E).
- `docs/project/sprint-6-fix-report.md` — iter 1 отчёт Code.
- `docs/project/test-cases-sprint-6-fix-retest.md` — runnable smoke (7 кейсов, кейс 2 обновлён под Phase F).
- `docs/project/sprint-report-4.md` + `sprint-4-fix-report.md` — история Sprint 4 BUG-5 (аналог BUG-Q6).
