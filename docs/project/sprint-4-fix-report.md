...
> Источник прицеливания: `docs/project/sprint-4-fix-prompt.md` + уточнения по BUG-3 в чате с пользователем (опция A — semantic shift). План: `~/.claude/plans/expressive-herding-swan.md`.
