...
> Источник прицеливания: `docs/project/sprint-7-fix-prompt.md` (F-1..F-9) + e2e сценарий A (`docs/project/e2e-scenarios-sprint-7.md`).
...
- `tests/**` — unit-тесты
- `docs/project/sprint-7-fix-report.md` — этот файл (исключение Code-зоны по §P-1)
