...
Для `/docs/tutorial` — пока stub «Туториалы готовятся в Sprint 9», cross-ref на `docs/project/e2e-scenarios-sprint-7.md`.
...
В `docs/project/sprint-8-fix-report.md`:
...
- `docs/project/sprint-8-prompt.md` — Sprint 8 main P-1..P-14
- `docs/project/sprint-8-report.md` — отчёт Code Sprint 8 main
- `docs/project/code-review-sprint-8.md` — review Sprint 8 main
- `docs/project/test-cases-sprint-8-retest.md` — retest Sprint 8 main (был запущен пользователем 2026-05-31, найдено 6 UX-улучшений)
