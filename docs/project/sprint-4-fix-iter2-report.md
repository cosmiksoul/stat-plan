...
> Источник прицеливания: `docs/project/sprint-4-fix-prompt.md` (iter 2 raздел) + audit table в `docs/project/test-cases-sprint-4.md` (BUG-9, BUG-9b). План: `~/.claude/plans/expressive-herding-swan.md`.
