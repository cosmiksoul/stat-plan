...
> Источник прицеливания: `docs/project/sprint-6-fix-prompt.md` + уточнения пользователя 2026-05-29 в чате (BUG-Q4 переформулирован как UI-унификация baseline ↔ MDE; baseline НЕ сбрасывается при смене metric_type — preserve like MDE).
...
- `docs/project/sprint-6-fix-report.md` — этот файл (исключение Code-зоны по §P-1)
