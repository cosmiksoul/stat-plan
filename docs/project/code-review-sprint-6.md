...
- `docs/project/sprint-report-6.md` (exception по P-1: sprint-report Code пишет сам)
...
> Sprint 6 готов к QA. Тест-кейсы + 6 готовых CSV-файлов в `docs/project/test-cases-sprint-6.md`. Особое внимание:
...
- `docs/project/sprint-report-6.md` — отчёт Code (Sprint 6 main)
- `docs/project/sprint-6-prompt.md` — prompt
...
- `docs/project/test-cases-sprint-6.md` — QA сценарии + CSV примеры (создаётся)
