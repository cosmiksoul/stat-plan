...
**Дата:** 2026-05-31
**Источник:** `docs/project/sprint-8-fix-prompt.md` (F-1..F-6, browser smoke пользователя)
...
- **NEW** `src/pages/DocsTutorialPage.jsx` — контент бывшего TutorialPage, cross-ref на `docs/project/e2e-scenarios-sprint-7.md`, header `← К документации`.
