...
**Источник:** `docs/project/sprint-7-fix-prompt.md` F-1..F-9 + `docs/project/sprint-7-fix-report.md`.
...
- `docs/project/sprint-7-fix-prompt.md` (F-1..F-9 spec)
- `docs/project/code-review-sprint-7-fix.md` (этот файл)
- `docs/project/test-cases-sprint-7-fix-retest.md` (после Task #54)
...
- `docs/project/sprint-7-fix-prompt.md` — спека F-1..F-9
- `docs/project/sprint-7-fix-report.md` — отчёт Code
- `docs/project/test-cases-sprint-7-fix-retest.md` — runnable smoke (TBD после этого review)
