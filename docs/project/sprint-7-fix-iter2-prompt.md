...
- `docs/project/sprint-7-fix-prompt.md` — iter 1 spec
- `docs/project/sprint-7-fix-report.md` — iter 1 отчёт Code
- `docs/project/code-review-sprint-7-fix.md` — review iter 1
- `docs/project/test-cases-sprint-7-fix-retest.md` — runnable smoke iter 1 (QA найдено BUG-7F1, BUG-7F2)
