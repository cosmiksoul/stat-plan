...
- `docs/project/sprints/sprint-6-fix-iter2-report.md` — этот файл (Code-зона исключение по §P-1 для отчётов)
...
1. Code-зона коммит-готова. Файлы для коммита:
   ...
   - **Code-зона исключение docs/:** `docs/project/sprints/sprint-6-fix-report.md` (iter 1), `docs/project/sprints/sprint-6-fix-iter2-report.md` (iter 2)
