...
В `docs/project/sprints/sprint-4-fix-iter2-report.md`:
...
- `docs/project/sprints/test-cases-sprint-4.md` — BUG-9, BUG-9b.
- `docs/context/decisions-log.md` — ADR-002 (round-trip контракт).
- `docs/project/sprints/sprint-4-fix-report.md` — что было сделано в iter 1.
