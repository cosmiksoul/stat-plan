...
В `docs/project/sprints/sprint-report-5.md` по шаблону (как Sprint 4):
...
- `docs/project/sprints/sprint-4-fix-iter2-report.md` — детали round-trip контракта который не должен сломаться
