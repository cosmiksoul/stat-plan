...
> Источник прицеливания: `docs/project/sprints/sprint-7-fix-prompt.md` (iter 2, G-1..G-4) + QA сценариев A+B после iter 1.
...
Code-зона per CLAUDE.md §P-1: `templates/notebook/**`, `src/**`, `tests/**`, + `docs/project/sprints/sprint-7-fix-iter2-report.md` (исключение §P-1). Cowork-зона не тронута. Новых npm-deps нет.
