...
После QA Sprint 4 (см. `docs/project/sprints/test-cases-sprint-4.md`) и оценки 5 сгенерированных ноутбуков (`docs/project/sprints/code-review-sprint-4.md` + промежуточный ассессмент пользователем) накопилось **10 пунктов** на fix:
...
В `docs/project/sprints/sprint-4-fix-report.md`. По phase + общая статистика тестов + bundle. Особое внимание:
...
- `docs/project/sprints/test-cases-sprint-4.md` — таблица багов (BUG-1...BUG-5, NB-BUG-1...NB-BUG-5).
- `docs/project/sprints/code-review-sprint-4.md` — Concern #3 (теперь = NB-BUG-2).
- `docs/project/sprints/sprint-report-4.md` — Known Issues, секция про editedExternally / round-trip.
