...
**Источник:** `docs/project/polish-pack-v2.md` (Pv2-1..18 минус Pv2-11, минус Pv2-4 закрытый) + `docs/project/sprints/ux-audit-2026-05-31.md`
...
**Stub pages:**
- `src/pages/TutorialPage.jsx` — заглушка с заголовком + текст «Туториал готовится. До завершения — посмотри сценарии в `docs/project/sprints/e2e-scenarios-sprint-7.md` репозитория». **ВАЖНО:** Cowork параллельно готовит финальный content в виде markdown — Code его потом инлайнит. На момент DEV-фазы — stub OK.
...
В `docs/project/sprints/sprint-polish-v2-report.md` (Code пишет, по образцу Sprint 7 FIX iter 2 report):
...
1. **Tutorial content rewrite** — переработать `docs/project/sprints/e2e-scenarios-sprint-7.md` в `docs/project/tutorial-content.md` (или прямо в `TutorialPage.jsx` markdown-инлайном) в формат user-facing walkthrough. CSV — downloadable. ~1.5 ч.
...
- `docs/project/sprints/ux-audit-2026-05-31.md` — UX audit findings A (tour) + B (consistency)
- `docs/project/sprints/sprint-7-fix-iter2-report.md` — origin для P-13 (parser aliases CR-1)
- `docs/project/sprints/code-review-sprint-7-fix.md` — origin для P-12 (D-2 midpoint CR-1)
