...
**Источник:** `docs/project/sprints/e2e-scenarios-sprint-7.md` — 3 сценария (A proportion / B continuous / C ratio) с готовыми CSV. **Rewrite в user-facing формате:**
...
В `docs/project/sprints/sprint-9-report.md` (Code пишет):
...
- `docs/project/sprints/e2e-scenarios-sprint-7.md` — source для C-3 tutorial rewrite
