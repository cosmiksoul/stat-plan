...
В `docs/project/sprints/sprint-report-7.md` (по шаблону Sprint 6):
...
- `docs/project/sprints/sprint-report-6.md` + Sprint 6 FIX reports — контекст backend hooks для Шага 4.
