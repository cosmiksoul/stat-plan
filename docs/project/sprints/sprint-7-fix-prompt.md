...
В `docs/project/sprints/sprint-7-fix-report.md` (короткий, по образцу sprint-6-fix-report.md):
...
- `docs/project/sprints/e2e-scenarios-sprint-7.md` — e2e сценарии, сценарий A прошёл и выявил оба gap'а.
- `docs/project/sprints/sprint-7-prompt.md` — оригинальный prompt (S10 включал только plt.rcParams styling, без plotting calls — мой gap в spec).
- `docs/project/sprints/sprint-report-7.md` — Code-отчёт Sprint 7 main.
- `docs/project/sprints/code-review-sprint-7.md` — C-1..C-3 concerns (не задеваем в этом FIX).
