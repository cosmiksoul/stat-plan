...
**Источник:** `docs/project/sprints/code-review-sprint-6.md` (concerns C-1, C-2) + QA smoke 2026-05-29 (BUG-Q1 recharts blocker, BUG-Q4 baseline.unit='fraction' для continuous → mega-sample, BUG-Q3 Q08 не реактивен).
...
В `docs/project/sprints/sprint-6-fix-report.md`:
