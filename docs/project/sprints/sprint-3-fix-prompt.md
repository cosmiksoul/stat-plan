...
После QA Sprint 3 (см. `docs/project/sprints/test-cases-sprint-3.md`, все 15 smoke-кейсов прошли `+`) остался **один known bug**, заранее зафиксированный ещё на этапе CODE REVIEW (см. `docs/project/sprints/code-review-sprint-3.md` Concern #2).
...
В `docs/project/sprints/sprint-3-fix-report.md` (отдельный файл, не правка `sprint-report-3.md`). Минимум:
...
- Code review concern #2: `docs/project/sprints/code-review-sprint-3.md`
- Test case #13: `docs/project/sprints/test-cases-sprint-3.md`
- Known Issue в Sprint 3 report: `docs/project/sprints/sprint-report-3.md` (секция Known Issues, пункт «AdvancedParams в approved-режиме НЕ disabled»)
