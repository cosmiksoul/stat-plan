...
**Источник:** `docs/project/sprints/sprint-7-fix-iter2-prompt.md` G-1..G-4 + `docs/project/sprints/sprint-7-fix-iter2-report.md`.
...
- `docs/project/sprints/sprint-7-fix-iter2-prompt.md` — спека G-1..G-4
- `docs/project/sprints/sprint-7-fix-iter2-report.md` — отчёт Code
- `docs/project/sprints/test-cases-sprint-7-fix-iter2-retest.md` — runnable smoke (TBD)
