...
|---|---|
| `docs/project/sprints/sprint-2-prompt.md` | Untracked. Это **мой** артефакт (Cowork) — должен попасть в репо вместе с code-review. |
...
git add .gitignore docs/project/sprints/sprint-2-prompt.md docs/project/Dev-Cycle.md docs/project/sprints/code-review-sprint-2.md
