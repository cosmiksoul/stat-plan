...
В `docs/project/sprints/sprint-8-fix-iter2-report.md` (короткий):
...
- `docs/project/sprints/sprint-8-fix-prompt.md` — Sprint 8 FIX iter 1 (6 F-items)
- `docs/project/sprints/sprint-8-fix-report.md` — Code-отчёт iter 1 (TBD когда Code запушит)
