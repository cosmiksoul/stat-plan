...
**Источник:** `docs/project/code-review-sprint-5.md` (concerns C-1..C-4) + (опционально) bugs из `docs/project/test-cases-sprint-5.md` (если QA выявит — будут дописаны ниже до передачи в Code).
...
В `docs/project/sprint-5-fix-report.md` (короткий):
...
- `docs/project/code-review-sprint-5.md` — concerns C-1..C-4
- `docs/project/test-cases-sprint-5.md` — smoke кейсы + эскалация E-1
- `docs/project/sprint-report-5.md` — отчёт Code Sprint 5 (Code-flagged side-finding)
