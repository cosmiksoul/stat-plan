...
В `docs/project/sprint-report-4.md` по шаблону (как Sprint 3). Особое внимание:
...
- `docs/project/sprint-report-3.md` — Sprint 3 контракт render.js (snapshot для round-trip)
